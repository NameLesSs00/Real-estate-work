    ...
    <div className="p-8 md:p-12 min-h-screen bg-[#FDFCFB] font-inter">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          ...
          <div className="flex gap-2 bg-[#F0EBE3] p-1.5 rounded-2xl w-fit shrink-0">
        ...
        <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-32 gap-4">
              ...
              <p className="text-[#64748B] text-lg font-medium">No inquiries found matching your criteria.</p>
            </div>
          ) : (
                  ...
                  <div className="flex gap-4 pt-4">
                    {selectedContact.status === 'Pending' && (
                      <button 
                        ...
                        className="flex-1 bg-blue-600 text-white py-4 rounded-2xl font-bold shadow-lg shadow-blue-600/20 hover:bg-blue-700 transition-all flex items-center justify-center gap-2"
                      >
