...
// Static asset paths (files in /public are served as static URLs)
...
const arrowLeft     = `${BASE}/famicons_arrow-back-outline.png`;
const arrowRight    = `${BASE}/famicons_arrow-back-outline (1).png`;
