    ...
    <main className="min-h-screen font-poppins">
      ...
      <section className="bg-white pt-36 pb-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* Heading */}
          <h1 className="text-[36px] md:text-[48px] font-bold text-[#1B2134] mb-4 leading-tight">
            Get in Touch with The Gate Estates
          </h1>
          <p className="text-[16px] text-gray-500 max-w-2xl leading-relaxed mb-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {infoCards.map((card) => (
              <div
                key={card.title}
                className="relative bg-[#F8F5F0] border border-[#ECECEC] rounded-[14px] p-10 flex flex-col items-center justify-center gap-6 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group min-h-[220px]"
              >
                ...
                {/* Icon Area - Simplified since icons have their own circles */}
      ...
      <section className="bg-[#ffffff] py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* Heading with Stars (1=biggest, 3=smallest) */}
          ...
          <h2 className="text-[36px] md:text-[44px] font-bold text-[#1B2134] mb-4">
            Let&apos;s Connect
          </h2>
          <p className="text-[15px] text-gray-500 max-w-2xl leading-relaxed mb-10">
          ...
          {/* Form Card */}
          <div className="bg-[#F0EBE3] rounded-[20px] p-8 md:p-12">
            <form className="flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
                ...
                <button
                  type="submit"
                  className="flex items-center gap-3 bg-[#1B2134] text-white px-8 py-3.5 rounded-full font-semibold text-[15px] hover:bg-[#2d3555] hover:scale-105 transition-all duration-300 whitespace-nowrap"
                >
                  Send Inquiry
      ...
      {/* ── Section 3: CTA Banner (White background now) ── */}
      <section className="relative bg-white py-24 px-6 overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto pt-16 px-4">
          <h2 className="text-[36px] md:text-[52px] font-bold text-[#1B2134] leading-tight mb-6 md:whitespace-nowrap">
          ...
          <Link
            href="/properties"
            className="inline-block bg-[#1B2134] text-white font-bold px-10 py-4 rounded-full text-[16px] hover:bg-[#D59E52] transition-all duration-300 shadow-lg hover:scale-105"
          >
            Explore Properties
          </Link>
        </div>
