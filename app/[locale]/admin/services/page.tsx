    ...
    <div className="p-8 md:p-12 min-h-screen font-inter bg-admin-bg">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            <h1 className="text-[36px] font-bold text-brand-primary mb-2">Unit Services</h1>
            <p className="text-admin-muted text-lg">Manage specialized services for units.</p>
          </div>
          <button 
                ...
                <tr key={service.id} className="hover:bg-gray-50/30 transition-colors group">
                  ...
                  <td className="px-8 py-6">
                    {editingId === service.id ? (
                      ...
                      <span className="font-bold text-brand-primary text-[16px]">{getDisplayName(service)}</span>
                    )}
                  </td>
