  ...
  return (
    <div className="min-h-screen bg-white font-inter pt-32 pb-20">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8">
        <h1 className="text-[28px] sm:text-[40px] font-bold text-[#000000] mb-8 sm:mb-12">Add Property</h1>
        ...
        <form className="space-y-12">
          ...
          <div className="bg-[#F8F5F080] rounded-[24px] p-6 sm:p-8 md:p-12 shadow-sm space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Property Title</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Price</label>
                <input 
                  type="text" 
                  placeholder="Price" 
                  required
              ...
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Unit Size</label>
                <input 
                  type="text" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Sale Or Rent</label>
              ...
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Rooms</label>
                <div className="relative">
                  <select required className="w-full bg-white border border-[#AAAAAA] rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-[#000000]/5 appearance-none text-[#000000]">
            ...
            <div className="space-y-2">
              <label className="text-[#000000] font-semibold text-[15px]">Description</label>
              <textarea 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Address</label>
                <input 
                  type="text" 
                  placeholder="Address" 
                  required
              ...
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Area</label>
                <input 
                  type="text" 
                  placeholder="Area" 
                  required
          ...
          <div className="bg-[#F8F5F080] rounded-[24px] p-6 sm:p-8 md:p-12 shadow-sm space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Full Name</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Email</label>
                <input 
                  type="email" 
                  placeholder="Email" 
                  required
              ...
              <div className="space-y-2">
                <label className="text-[#000000] font-semibold text-[15px]">Phone Number</label>
                <input 
                  type="text" 
