      ...
      >
        ...
        <div className="p-8 overflow-y-auto space-y-6 scrollbar-hide">
          ...
          <div className="space-y-2">
            <label className="text-brand-primary font-semibold text-[15px]">
              Developer Name *
            </label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-gray-200 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-brand-primary/20 text-brand-primary placeholder-gray-400 resize-none"
            />
          </div>
