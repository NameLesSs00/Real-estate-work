...
export default function DeleteDeveloperModal({ isOpen, onClose, onConfirm, developerName }: DeleteDeveloperModalProps) {
      ...
      >
        ...
        <div className="p-10 text-center space-y-8">
          <p className="text-[#475467] text-[18px] leading-relaxed">
            Are you sure you want to delete <span className="font-bold text-[#16273B]">{developerName || 'this developer'}</span>? This action cannot be undone.
          </p>
