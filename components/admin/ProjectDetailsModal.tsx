        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide p-8 space-y-8">
          {isLoading ? (
            ...
            <>
              {/* Name + meta */}
              <div>
                <h3 className="text-[26px] font-bold text-brand-primary">{project.name}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={label} className="bg-brand-secondary-soft rounded-2xl px-6 py-5">
                    <p className="text-[13px] text-gray-500 font-medium mb-1">{label}</p>
                    <p className="text-brand-primary text-[16px] font-bold">{value}</p>
                  </div>
                ))}
              </div>
              ...
              {/* Units List */}
              <div>
                <h4 className="text-[18px] font-bold text-brand-primary mb-4">
                    ...
                    {project.units.map((unit) => (
                      <div key={unit.id} className="bg-white border border-gray-100 rounded-2xl p-4 flex gap-4 hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 min-w-0">
                          <h5 className="font-bold text-brand-primary text-[15px] truncate">
                            {typeof unit.name === 'string' ? unit.name : (unit.name?.en || 'Untitled')}
                          </h5>
                          <p className="text-brand-primary font-bold text-[13px] mt-0.5">
