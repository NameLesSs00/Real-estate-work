...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#071F49] text-white py-12 md:py-16 px-6 md:px-20 font-poppins border-t border-[#123F7C]">
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col items-start">
            ...
            />
            <div className="h-[2px] w-12 bg-[#BF9C48] mb-6"></div>
          </div>
          <p className="text-[15px] leading-[1.8] text-[#D7E8FA] max-w-[300px]">
            {t('footer.about')}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-4 text-[#D7E8FA] font-medium">
            <li><Link href={`/${language}`} className="hover:text-[#BF9C48] hover:translate-x-1 inline-block transition-all">{t('header.home')}</Link></li>
            <li>
              <Link href={`/${language}/projects`} className="flex items-center gap-2 hover:text-[#BF9C48] hover:translate-x-1 transition-all w-fit">
                {t('header.projects')} 
            ...
            <li><Link href={`/${language}/about`} className="hover:text-[#BF9C48] hover:translate-x-1 inline-block transition-all">{t('header.about')}</Link></li>
            <li>
              <Link href={`/${language}/properties`} className="flex items-center gap-2 hover:text-[#BF9C48] hover:translate-x-1 transition-all w-fit">
                {t('header.buy')} 
                <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 1L6 6L11 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
            ...
            <li><Link href={`/${language}/blogs`} className="hover:text-[#BF9C48] hover:translate-x-1 inline-block transition-all">{t('header.blogs')}</Link></li>
            <li><Link href={`/${language}/contact`} className="hover:text-[#BF9C48] hover:translate-x-1 inline-block transition-all">{t('header.contact')}</Link></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-6 text-[#D7E8FA] font-medium">
      ...
      {/* Copyright */}
      <div className="mt-20 pt-8 border-t border-white/15 text-center text-[14px] text-[#A9C7E8] font-medium">
        <p>
          {t('footer.copyright')} Powered By{" "}
          <a 
            href="https://tech-gear.net/" 
            className="inline-block text-white hover:text-[#BF9C48] hover:-translate-y-0.5 transition-all duration-300 font-bold"
          >
            Tech Gear Solutions
          </a>{" "}
          © 2026
